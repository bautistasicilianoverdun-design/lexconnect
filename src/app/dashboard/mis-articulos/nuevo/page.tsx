...
export default async function NuevoArticuloPage() {
  ...
  if (!lawyerProfile) redirect('/dashboard/mis-articulos')
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Nuevo articulo</h1>
          <p className="text-sm text-slate-500 mt-0.5">Compartí tu conocimiento legal</p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6 space-y-5">
          <div>
            ...
            <input
              ...
              type="text"
              required
              placeholder="Ej: Como proteger tus derechos laborales en Argentina"
          ...
          <div>
            ...
            <textarea
              name="excerpt"
              rows={2}
              placeholder="Breve descripcion del articulo (aparece en el listado)"
          ...
          <div>
            ...
            <textarea
              ...
              rows={16}
              required
              placeholder="Escribi el contenido del articulo. Separa los parrafos con una linea en blanco."
            ...
            />
            <p className="text-xs text-slate-400 mt-1">Separa los parrafos con una linea en blanco para mejor legibilidad.</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <label className="flex items-center gap-3 p-4 rounded-xl border border-slate-200 hover:border-blue-300 cursor-pointer flex-1 transition-colors">
              <input type="radio" name="status" value="draft" defaultChecked className="text-blue-600" />
              <div>
                <p className="text-sm font-semibold text-slate-900">Guardar borrador</p>
            ...
            <label className="flex items-center gap-3 p-4 rounded-xl border border-slate-200 hover:border-green-300 cursor-pointer flex-1 transition-colors">
              <input type="radio" name="status" value="published" className="text-green-600" />
              <div>
                <p className="text-sm font-semibold text-slate-900">Publicar ahora</p>
